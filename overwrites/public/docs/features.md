...
**What is Tacheles?** 
Tacheles is an online workspace for collaborative writing at the Belgrade Center for Digital Humanities (BCDH). We use it for taking notes in meetings, composing articles, creating training materials etc. 

**Why is it called Tacheles?**
It's just a name. The word itself is nowadays used in the German expression *Tacheles reden*, which means *to talk straight*, *to speak frankly*. Both the word and the expression stem from the Yiddish תּכלית‎ [taxˈlɛs] = *goal*, *purpose* and תּכלית רעדן‎ [taxˈlɛs redn] = *speak to the point*. 

**What's the software behind Tacheles?**
Tacheles is powered by [**CodiMD**](https://github.com/hackmdio/codimd),  a real-time, multi-platform collaborative markdown note editor. 

**Can anybody use Tacheles?**
Unfortunatley, no. We use Tacheles only internally and with our partners, but cannot provide support for public use. If you are interested in the functionalities of CodiMD but cannot host an installation yoursef, check out the [hackmd.io](https://hackmd.io) 
